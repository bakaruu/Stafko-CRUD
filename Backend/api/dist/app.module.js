...
const tasks_entity_1 = require("./tasks/domain/entities/tasks.entity");
    ...
    (0, common_1.Module)({
        imports: [
            typeorm_1.TypeOrmModule.forRoot({
                ...
                password: 'password',
                database: 'postgres',
                entities: [user_entity_1.User, client_entity_1.Client, project_entity_1.Project, tasks_entity_1.Task],
                synchronize: true,
            }),
