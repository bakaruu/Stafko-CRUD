    ...
    return (
        <div className="bg-white p-3 border-t-4 border-orange-200">
            ...
            <ul className="bg-gray-100 text-gray-600 hover:text-gray-700 hover:shadow py-2 px-3 mt-3 divide-y rounded shadow-sm">
                ...
                <li className="flex items-center py-3">
                    <span>Progress</span>
                    <span className="text-center align-baseline inline-flex px-2 py-1  items-center font-semibold text-base/none text-success bg-success-light rounded-lg ml-auto">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-5 h-5 mr-1">
                        <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 18L9 11.25l4.306 4.307a11.95 11.95 0 015.814-5.519l2.74-1.22m0 0l-5.94-2.28m5.94 2.28l-2.28 5.941" />
                    </svg> {project.progress}% </span></li>
            </ul>
        </div>
    );
}
